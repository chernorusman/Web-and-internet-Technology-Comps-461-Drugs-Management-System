...
<body style="background:rgb(226, 221, 214)">
    <div class="container">
        <div class="row mt-5">

            <div class="col-md-12 text-center">
                <h1 class="display-3">Management System</h1>
            </div>
            <div class="col-md-5 p-5">
                <form action="login.php" method="post" autocomplete="off">
                    <h4 class="text-uppercase">Login as Admin</h4>
           ...
           <div>
               <h1>Create an account if you don't have to Start management system</h1>
           </div>
            <div class="col-md-7 p-5">
                <form action="login.php" method="POST" autocomplete="off">
                    <h4 class="text-uppercase">Create Administration Account</h4>
