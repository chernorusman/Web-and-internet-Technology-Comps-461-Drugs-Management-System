...
?>
<div style="background-color:rgb(98, 219, 158);">
<?php set_header("Home") ?>
...
<div class="container-fluid">
  <div class="row mt-5 px-5">
    <div class="col-md-12">
      ...
      <a href="saveMedicine.php" class="btn btn-primary mb-3 mr-3">Save New Medicine</a> <br>
        ...
        <table class="table table-striped table-light">
          <thead>
            <tr>
              ...
              <th>Name.</th> <th>Dosage Quantity.</th> <th>Dosage Unit.</th> <th>Measurement Quantity.</th> <th>Measurement Unit.</th>
              <th>Frequency Quantity.</th> <th>Frequency Unit.</th> <th colspan="2">Actions.</th>
            </tr>
          </thead>
          <tbody>
          <?php
